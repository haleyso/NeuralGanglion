...
def triple_random_crop(img_gts, img_lqs, voxels, gt_patch_size, scale, gt_path, debug=False):
    """Triple random crop.
    ...
    if gt_patch_size == None or scale==None:
...
def random_crop(img_gts, gt_patch_size, scale, gt_path):
    """Double random crop.
    ...
    # print(img_gts[0].shape) # 256,256,3
